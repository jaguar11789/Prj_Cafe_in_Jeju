...
public class JoinController {
	...
	/*
	 * @RequestMapping("/joinsucess_user") public String
	 * joinsucess_user(HttpServletRequest request, Model model) {
	 * 
	 * 
	 * JoinDao joindao = session.getMapper(JoinDao.class); UserInfoDto userdto =
	 * joindao.joinsucess_user();
	 * 
	...
	public String sucessjoinuser(HttpServletRequest request, Model model)
		...
		joindao.sucessjoinuser(userid, userpwd, usershapwd, usernickname, useremail, userpnum, username, userbirth,
				usersex);
...
//	      return "redirect:joinsucess_user";
	...
	public String sucessjoinbusiness(HttpServletRequest request, Model model)
		...
		JoinDao joindao = session.getMapper(JoinDao.class);
		joindao.sucessjoinbusiness(businessid, businesspwd, businessshapwd, businessnickname, businessemail,
				businesspnum, businessname, businessreginum, businessbirth, businesssex);
