package com.tech.cafeinfo.vopage;
...
public class PageVO {
	 ...
	 */
	public void pageCalculate(Integer total2) {
		getPage();
		totRow = total2;// 전체 글의 개수
		totPage = (int) (total2 / displayRowCount);//

		if (total2 % displayRowCount > 0) {
			totPage++;
		}
