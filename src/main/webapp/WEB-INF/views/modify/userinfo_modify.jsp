...
<body>
    <div id="grid">
        ...
        <div class="gridinfo">
            <h3><b style="color: #444444;">개인정보 변경</b></h3>
            <hr>
            ...
            <input type="button" name="user_name" value="변경"> <br>
            <hr>
            <span id="user_nickname" style="color: #444444;">닉네임</span> 
            <input type="text" placeholder="58년개띠">
            <input type="button" name="user_nickname" value="변경"> <br>
            <hr>
            <span id="user_email" style="color: #444444;">이메일</span> jaguar11789@naver.com
            <input type="button" name="user_email" value="변경"> <br>
            <hr>
            ...
            <input type="button" value="변경"> <br>
            <hr>

            <button class="custom-btn btn-6">변경사항 저장</button>
        </div>
    </div>
