...
<body>
    <div id="grid">
        <ul>
            ...
            <hr>
            <li>
               <a href="user_modify_info.html" style="color: #444444;"><b>개인정보 변경</b></a><br>
            </li>
            <li>
               <a href="user_modify_pwd.html" style="color: #444444;">비밀번호 변경</a><br>
            </li>
            <li>
               <a href="user_modify_sec.html" style="color: #444444;">회원탈퇴</a>
            </li> 
         </ul>
        <div class="gridinfo">
            ...
            <a href="./userinfo_modify"><input type="button" name="user_email" value="확인"></a>
            <hr>
        </div>
    </div>
