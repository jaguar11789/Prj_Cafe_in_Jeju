   ...
   <div id="grid">
      ...
      <div id="joinform">
        ...
        <div id="input_container">
            ...
            <input type="text" class="input_value" placeholder=" 이름을 입력해주세요."> <br>
            <label for="" class="input_label">닉네임</label> <br>
            <input type="text" class="input_value" placeholder=" 닉네임을 입력해주세요."> <br>
            <label for="" class="input_label">휴대폰</label> <br>
            <input type="text" class="input_value" placeholder=" 휴대폰번호를 입력해주세요."> <br>
            <label for="" class="input_label">이메일</label> <br>
            <input type="text" class="input_value" placeholder=" 이메일을 입력해주세요."> <br>
