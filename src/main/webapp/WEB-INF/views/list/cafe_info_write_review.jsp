...
<script src="https://kit.fontawesome.com/499fd37eb6.js" crossorigin="anonymous"></script>
<style>
	/* header */
input[id="menuicon"] {
  display: none;
		  ...
		  <div class="menu">
			...
			<div class="sidebar">
			  <div class="category">
				<ul>
				  <li class="menu_logo">
					<a  href="main"><img src="img/logo2.png" alt=""></a>
				  </li>
				  <li class="menu_local">
						...
						<table>
							<tr>
								...
								<div class="right-button">
									<a href="cafe_info_write_review" ><button class="custom-btn btn-5"><span id="cafe_write_review">리뷰작성</span></button></a>
...
starscore.click(function (event) {
   x = event.clientX;
   alert('x좌표:' +x);
})
</script>
