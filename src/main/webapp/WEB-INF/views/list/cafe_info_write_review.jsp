      ...
      <div class="container">
         <div class="menu">
            ...
            <div class="sidebar">
               <div class="category">
                  <ul>
                     <li class="menu_logo"><a href="main"><img
                           src="img/logo2.png" alt=""></a></li>
         ...
         <div class="row g-0">
            ...
            <div class="col-md-12">
               ...
               <form action="writereview" method="post"
                  ...
                  <input type="text" name="reviewtitle" class="reviewtitle"
                  ...
                  <div class="image-container">
                     ...
                     <input style="display: block;" type="file" id="input-image" name="reviewphoto">
                  </div>
